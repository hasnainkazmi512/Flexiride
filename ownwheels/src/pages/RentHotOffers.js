...
import styles from "../styles/RentHotOffers.module.css";

const RentHotOffers = ({ offers }) => {
  ...
  return (
    <div className={styles.rentHotOffers}>
      ...
      <div className={styles.offersGrid}>
        {offers.slice(0, 3).map((offer) => (
          ...
          >
            <img src={offer.image} alt={offer.name} className={styles.carImage} />
            <h3>{offer.name}</h3>
